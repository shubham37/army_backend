...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(max_length=10, verbose_name='Psych Test Code')),
                ('qusetion', models.CharField(blank=True, max_length=128, null=True, verbose_name='Psych Test Code')),
            ],
        ),
        migrations.CreateModel(
            name='State',
